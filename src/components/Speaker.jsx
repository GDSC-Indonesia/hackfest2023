...
export default function Speaker() {
  ...
  return (
    <section className="border-b-2 border-black bg-gooYellow-500 py-8">
      <div className="text-center h-full">
        <h2 className="font-gooBold text-5xl mb-4">Speakers</h2>
        <p className="font-gooReg text-2xl mb-8">Current Speakers, might change in the future.</p>
      </div>
