  ...
  return (
    <section className='HackfestDetail border-b-2 border-black'>
        <div className='grid grid-cols-12'>
            <div className='col-span-12 md:col-span-6 py-[14%] 2xl:py-[8%] px-[10%] flex items-start justify-center 2xl:justify-center flex-col bg-gooBlue-900 border-b-2 md:border-b-0 md:border-r-2 border-black'>
            ...
            <div className='col-span-12 md:col-span-6 py-[14%] 2xl:py-[8%] px-[10%] flex items-center justify-center flex-col bg-gooRed-900'>
